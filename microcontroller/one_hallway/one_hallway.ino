...
// one_hallway SETUP (IN, IN, OUT, OUT, OUT, OUT)

String hwid = "one_hallway";
...
//  pin3_cumulative = pin3_cumulative + pin3_status;
  ...
  if (counter == counter_reference){
    ...
    // Store Input
    String input_url_w_data = input_url + pin1_cumulative + "z" + pin2_cumulative;
    ...
    if (output_http_response_code > 0) {
      ...
      pin3_output_status = payload.substring(0,1);
      pin4_output_status = payload.substring(2,3);
